            ...
            if($this->loggedin){ 
                ...
                switch ($this->pageID) {
                    ...
                    case "home":
                        ...
                        $this->menuNav.='<li><a href="'.$_SERVER['PHP_SELF'].'?pageID=manageJobs">Manage Jobs</a></li>';
                    ...
                    case "manageJobs":
                        ...
                        $this->menuNav.='<li><a href="'.$_SERVER['PHP_SELF'].'?pageID=editJob">Edit Job</a></li>';
                        $this->menuNav.='<li><a href="'.$_SERVER['PHP_SELF'].'?pageID=addJob">Add Job</a></li>';
                        $this->menuNav.='<li><a href="'.$_SERVER['PHP_SELF'].'?pageID=logout">Log Out</a></li>';
                        break;
